...
<div class="modal fade" id="Tambah" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            // Form buka 
            echo form_open(base_url('admin/kategori_barang'));
            ?>
...
<table class="table table-bordered table-hover table-striped" id="example1">
    ...
    <?php $i=1; foreach($kategori_barang as $kategori) { ?>
    ...
    <tr class="odd gradeX">
        ...
        <td>
            ...
            <a href="<?php echo base_url('admin/kategori_barang/edit/'.$kategori->id_kategori) ?>" 
            class="btn btn-warning btn-xs"><i class="fa fa-edit"></i></a>

            <a href="<?php echo base_url('admin/kategori_barang/delete/'.$kategori->id_kategori) ?>" 
