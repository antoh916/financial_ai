...
<div class="row">
    ...
    <div class="col-md-4">
        ...
        <div class="form-group">
            ...
            <select name="id_kategori_barang" class="form-control">
                ...
                <?php if($barang->id_kategori==$kategori_barang->id_kategori) { echo "selected"; } ?>
                ><?php echo $kategori_barang->nama_kategori ?></option>
                <?php } ?>
    ...
    <div class="col-md-4">
        ...
        <div class="form-group">
            <label>Harga</label>
            <input type="number" name="harga" class="form-control" placeholder="" value="<?= $barang->harga; ?>">
    ...
    <div class="col-md-4">
        <div class="form-group">
            ...
            <textarea name="deskripsi" class="form-control" required="required"><?= $barang->deskripsi;?></textarea>
        </div>
    </div>
