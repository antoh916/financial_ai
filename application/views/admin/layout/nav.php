        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
            <a href="#" class="nav-link">
              ...
              <p>Barang <i class="right fa fa-angle-left"></i></p>
            </a>
            <ul class="nav nav-treeview">
              <li class="nav-item"><a href="<?php echo base_url('admin/kategori_barang') ?>" class="nav-link"><i class="fa fa-table nav-icon"></i><p>Kategori Barang</p></a>
              </li>
              <li class="nav-item"><a href="<?php echo base_url('admin/barang') ?>" class="nav-link"><i class="fa fa-table nav-icon"></i><p>Barang</p></a>
              </li>
